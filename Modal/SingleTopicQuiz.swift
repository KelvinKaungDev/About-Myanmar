...
struct SingleTopicQuiz {
    ...
    let quizs = [
        ...
        [QuizBrain(question: "Water festival is the most important festival in Myanmar?", multipleChoice: ["True", "False"], answer: "True", sound : true),
          QuizBrain(question: "The another word for Myanmar Water festival ?", multipleChoice: ["Thingyan", "Thadingyut", "Tha Saung Thie"], answer: "Thingyan", sound : true),
          ...
          QuizBrain(question: "What is the hightlight of Tha Saung Thie Festival ?", multipleChoice: ["Fire Balloon", "Lighting", "Water"], answer: "Fire Balloon", sound : true),
         QuizBrain(question: "Your Total Score is", multipleChoice: ["RETAKE"], answer: "", sound : false)
        ],
        [QuizBrain(question: "Pae Pyote and Nan Pyar represent the myanmar independence day ", multipleChoice: ["True", "False"], answer: "True", sound : true),
          QuizBrain(question: "When you come to Myanmar during water festival, which food you should try ?", multipleChoice: ["Mote Lone Yay Paw", "Pae Pyote and Nan Pyar", "Laphet Thoke"], answer: "Mote Lone Yay Paw", sound : true),
        ...
        [QuizBrain(question: "Who got the peace Nobel Prize in Myanmar?", multipleChoice: ["Daw Aung San Su Kyi", "Malala Yousafzai", "Nadia Murad"], answer: "Daw Aung San Su Kyi", sound : true),
          ...
          QuizBrain(question: "Who is the first non-European and the first Asian to hold the position of Secretary-General of the United Nations.", multipleChoice: ["U Thant", "Daw Aung San Su Kyi", "Htoo Eain Thin"], answer: "U Thant", sound : true),
         QuizBrain(question: "Who is the iconic musician in Myanmar", multipleChoice: ["Justin Bieber", "Adele", "Htoo Eain Thin"], answer: "Htoo Eain Thin", sound : true),
         QuizBrain(question: "Your Total Score is", multipleChoice: ["RETAKE"], answer: "", sound : false)
        ],
    ]
