...
struct TotalQuiz {
    ...
    let quizs = [
        ...
        QuizBrain(question: "The another word for Myanmar Water festival ?", multipleChoice: ["Thadingyut", "Thingyan", "Tha Saung Thie"], answer: "Thingyan", sound : true),
        ...
        QuizBrain(question: "Who is the first non-European and the first Asian to hold the position of Secretary-General of the United Nations.", multipleChoice: [ "Daw Aung San Su Kyi", "Htoo Eain Thin", "U Thant"], answer: "U Thant", sound : true),
        ...
        QuizBrain(question: "What is popular gift to bring back home for friends and family in Myanmar.", multipleChoice: ["Mote Lone Yay Paw", "Pizza", "Lat Phat Thoke"], answer: "Lat Phat Thoke", sound : true),
